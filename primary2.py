...
inputPin1 = 23
inputPin2 = 24
GPIO.setup(inputPin1,GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
GPIO.setup(inputPin2,GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
statusPin1 = 5
statusPin2 = 6
GPIO.setup(statusPin1,GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
GPIO.setup(statusPin2,GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
motorPin = 26
...
# Set motorPin to high, if HIGH motor can proceed, if LOW then detection or camera down so motor should stop
